...
uses
  ...
  MainModule in 'MainModule.pas' {c: TUniGUIMainModule},
  Mainm in 'Mainm.pas' {MainmForm: TUnimForm},
  umain in 'units\umain.pas' {UniMainFrame: TUniFrame},
  uPedidos in 'uPedidos.pas' {frmPedidos: TUnimForm},
  ...
  uLogin in 'uLogin.pas' {UnimLogin: TUnimLoginForm},
  uItens in 'uItens.pas' {frmItens: TUnimForm},
